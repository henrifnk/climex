...
class TestTrainConvLSTM(unittest.TestCase):

    # Class methods --------------------------------------------------------------------------------
    @classmethod
    def setUpClass(cls):
        cls.path_to_data = 'climex/tests/testdata/training_database_daily_unit_tests.nc'
        cls.model_dir = 'climex/tests/testmodels_results/ConvLSTM/'
    ...
    def test_argument_checks(self):
        ...
        with self.assertRaises(SystemExit) as cm:
            train_conv_lstm(n_years_test=-1)
